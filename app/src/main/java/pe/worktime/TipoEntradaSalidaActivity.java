...
public class TipoEntradaSalidaActivity extends AbstractActivity {

	public static int viewLoad = R.layout.tipo_entrada_salida;
	...
	protected void postLoadView() {
		...
		btnManual.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				ContextTest.idxTipoEntradaSalida = 0;
