...
public class SalidaAsistenciaActivity extends AbstractActivity {
	...
	private static SalidaAsistenciaActivity actual;
	...
	public static void reloadProducts() {
		...
		if (actual != null) {
			Log.d("INFO", "AKA 2");
			Log.d("INFO", Application.context.getHorasConsumidorController()
