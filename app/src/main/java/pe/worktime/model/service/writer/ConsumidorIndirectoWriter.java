...
public class ConsumidorIndirectoWriter extends AbstractWriterXML {

	private KeyTransac key;

	public ConsumidorIndirectoWriter(KeyTransac key) {
		this.key = key;
	}
	...
	protected String writeBodyXML() {
		...
		buffer.append("<Master_Consumidor_Indirecto xmlns=\"http://tempuri.org/\">");
		{
			buffer.append("<key");
			{
		...
		buffer.append("</Master_Consumidor_Indirecto>");
