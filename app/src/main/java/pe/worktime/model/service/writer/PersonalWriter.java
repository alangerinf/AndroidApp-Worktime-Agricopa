...
public  class PersonalWriter extends AbstractWriterXML {


    private KeyTransac key;

    public PersonalWriter(KeyTransac key) {
        this.key = key;
    }
    ...
    protected String writeBodyXML() {
        ...
        buffer.append("<Master_Trabajador xmlns=\"http://tempuri.org/\">");
        {
            buffer.append("<key");
            {
        ...
        buffer.append("</Master_Trabajador>");
