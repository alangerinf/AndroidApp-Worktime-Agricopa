...
public class GrupoWriter extends AbstractWriterXML {

	private KeyTransac key;

	public GrupoWriter(KeyTransac key) {
		this.key = key;
	}
	...
	protected String writeBodyXML() {
		...
		buffer.append("<Master_Grupo xmlns=\"http://tempuri.org/\">");
		{
			buffer.append("<key");
			{
