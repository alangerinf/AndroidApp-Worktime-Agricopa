...
public class DHorasConsumidorIngresoAdapter extends ArrayAdapter<HorasConsumidorDetalle>{

	private LayoutInflater inflater = null;	
	private int template_row = R.layout.list_row_asistentes_ingreso;
	
	public DHorasConsumidorIngresoAdapter(Context context, int textViewResourceId,List<HorasConsumidorDetalle> objects, Activity activity) {
