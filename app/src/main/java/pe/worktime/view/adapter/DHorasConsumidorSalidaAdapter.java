...
public class DHorasConsumidorSalidaAdapter extends ArrayAdapter<HorasConsumidorDetalle>{

	private LayoutInflater inflater = null;	
	private int template_row = R.layout.list_row_asistentes_salida;
	
	public DHorasConsumidorSalidaAdapter(Context context, int textViewResourceId,List<HorasConsumidorDetalle> objects, Activity activity) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {		
		...
		//title.setText(prod.getCodTrabajador());

		if (prod.getCodTrabajador().equalsIgnoreCase("")){
			title.setText("DNI: "+prod.getCodTrabajador());
		}else{
			title.setText("DNI: "+prod.getCodTrabajador()+"    "+ Application.context.getPersonalController().buscarPersonal(prod.getCodTrabajador()).getNombreApellido());
		}
        
        /*if(prod.getHoraInicio().equalsIgnoreCase("")){
            artist.setText(prod.getHoraInicioMovil());            
        }else{
            artist.setText(prod.getHoraInicio());            
        } 
        */
