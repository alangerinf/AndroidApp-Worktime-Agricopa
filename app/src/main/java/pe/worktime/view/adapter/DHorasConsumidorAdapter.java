...
public class DHorasConsumidorAdapter extends ArrayAdapter<HorasConsumidorDetalle>{

	private LayoutInflater inflater = null;	
	private int template_row = R.layout.list_row_entrada;
	
	public DHorasConsumidorAdapter(Context context, int textViewResourceId,List<HorasConsumidorDetalle> objects, Activity activity) {
